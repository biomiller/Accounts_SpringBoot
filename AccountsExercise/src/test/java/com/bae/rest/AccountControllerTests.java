...
public class AccountControllerTests {
	...
	public void createAccountTest() {
		...
		Mockito.when(service.createAccount(Constants.MOCK_ACCOUNT_1)).thenReturn("No Prize.");
		
		assertEquals("No Prize.", controller.createAccount(Constants.MOCK_ACCOUNT_1));
